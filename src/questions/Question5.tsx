        ...
        <Box padding={"50px"}>
            <QuestionText>
                <Text fontSize="2xl" alignSelf={"baseline"} textAlign={"center"}>
                    ...
                    {<br />} {<br />}
                    On the Marble Board of Olympus, guide the sacred pieces (which move like knights in chess) from the starting board to the final board in the fewest moves possible.
                </Text>
            </QuestionText>
